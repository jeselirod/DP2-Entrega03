...
public interface CurriculaRepository extends JpaRepository<Curricula, Integer> {
	...
	@Query("select c from Curricula c where c.id=?1 and c.personalData.id=?2")
	public Curricula getCurriculaByPersonalData2(Integer curriculaId, Integer personalDataId);
